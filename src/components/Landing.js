...
export default function Landing() {
    return (
        <motion.div variants={pageAnim} initial="hidden" animate="show" className="landing-container" exit="exit">
           <div className="description">
               ...
               <motion.p variants={fade}>Auteur de romans à succès traduits internationalement</motion.p>
               <motion.button variants={fade}><Link to="/ouvrages">Consulter les ouvrages</Link></motion.button>
           </div>
           <Wave></Wave>
